...
const puzzles = {
    ...
    2: {
        dialogs: [
            ...
            { text: "<AI> RECUPERACIÓN DE SERVIDOR: █ 10%", color: "white" },
            { text: "<AI> RECUPERACIÓN DE SERVIDOR: 0%ㅤ", color: "white" },
    ...
    3: {
        dialogs: [
            ...
            { text: "SISTEMA: <???> se ha desconectado.", color: "#B027F5" },
    ...
    5: {
        dialogs: [
            ...
            { text: "SISTEMA: *ERROR* FALLA CRITICA, FALLA CRITICA", color: "#B027F5" },
            { text: "SISTEMA: *ERROR* FALLA CRITICA, FALLA CRITICA", color: "#B027F5" },
            { text: "SISTEMA: *ERROR* FALLA CRITICA, FALLA CRITICA", color: "#B027F5" },
            { text: "SISTEMA: *ERROR* FALLA CRITICA, FALLA CRITICA", color: "#B027F5" },
